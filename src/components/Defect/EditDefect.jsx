...
const EditDefect =() => {
    ...
    const handleSubmit = async(e) => {
        e.preventDefault();
        try{
            const data = await updateDefect(id,defect.code,defect.name,defect.description,defect.severity,defect.status,defect.confirmed);
            navigate("/edit", { state: { message: "Defect successfully updated!" } });
