...
export default function DriverDropdown({ handleExit, onSave, onSaveAs, onSaveAll, onSelect }) {
  return (
    <NavDropdown title="Driver" id="top-nav-driver">
      ...
      <NavDropdown.Item as={Link} to="/driver/">Driver-report</NavDropdown.Item>
      <NavDropdown.Item as={Link} to="/driver/drivers-report">Drivers-report</NavDropdown.Item>
